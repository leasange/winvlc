 ...
 *
 * \param p_mi the media player
 * \return the video aspect ratio or NULL if unspecified,or "fill"
 ...
 *
 * \param p_mi the media player
 * \param psz_aspect new video aspect-ratio or NULL to reset to default,"fill" to fill the window
...
LIBVLC_API int libvlc_video_toggle_record(libvlc_media_player_t *p_mi, const char *psz_filepath,const char*psz_filename);
LIBVLC_API int libvlc_video_is_recording(libvlc_media_player_t *p_mi);
/**
